...
var SCHEMA_GLOBAL = {
  "constructors": [
    ...
    {
      "id": 1562426088,
      "predicate": "messageActionChangeCommunity",
      "params": [
        {
          "name": "flags",
          "type": "#"
    ...
    {
      "id": 666573532,
      "predicate": "inputNotifyCommunity",
      "params": [
        {
          "name": "community",
          "type": "InputChannel"
    ...
    {
      "id": 3453225277,
      "predicate": "updateBotGuestChatQuery",
      "params": [
        {
          "name": "flags",
          "type": "#"
    ...
    {
      "id": 549239713,
      "predicate": "updateNewEphemeralMessage",
      "params": [
        {
          "name": "message",
    ...
    {
      "id": 1457257720,
      "predicate": "updateDeleteEphemeralMessages",
      "params": [
        {
          "name": "peer",
          "type": "Peer"
    ...
    {
      "id": 1270583041,
      "predicate": "updateEditEphemeralMessage",
      "params": [
        {
          "name": "message",
          "type": "EphemeralMessage"
    ...
    {
      "id": 1777300164,
      "predicate": "inputDialogPeerCommunity",
      "params": [
        {
          "name": "community",
          "type": "InputChannel"
    ...
    {
      "id": 2005007896,
      "predicate": "webPageAttributeAiComposeTone",
      "params": [
        {
          "name": "emoji_id",
          "type": "long"
    ...
    {
      "id": 1092204894,
      "predicate": "inputReplyToEphemeralMessage",
      "params": [
        {
          "name": "id",
          "type": "int"
    ...
    {
      "id": 535407039,
      "predicate": "inputAiComposeToneDefault",
      "params": [
        {
          "name": "tone",
          "type": "string"
    ...
    {
      "id": 125026432,
      "predicate": "inputAiComposeToneID",
      "params": [
        {
          "name": "id",
          "type": "long"
    ...
    {
      "id": 530584407,
      "predicate": "inputAiComposeToneSlug",
      "params": [
        {
          "name": "slug",
          "type": "string"
    ...
    {
      "id": 235681199,
      "predicate": "inputAiComposeToneSingleUse",
      "params": [
        {
          "name": "custom_prompt",
          "type": "string"
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          ...
          "type": "flags.5?AiComposeToneExample"
        }
      ],
      "type": "AiComposeTone"
    },
    {
      "id": 2611831828,
      "predicate": "aiComposeToneDefault",
      "params": [
        {
          "name": "tone",
          "type": "string"
    ...
    {
      "id": 3254018307,
      "predicate": "aicompose.tonesNotModified",
      "params": [],
    ...
    {
      "id": 2200444349,
      "predicate": "inputRichFileDocument",
      "params": [
        {
          "name": "id",
          "type": "string"
    ...
    },
    {
      ...
      "params": [
        ...
        {
          "name": "files",
          "type": "flags.2?Vector<InputRichFile>"
        }
      ],
      "type": "InputRichMessage"
    },
    ...
    {
      "id": 2078997125,
      "predicate": "communityPeerRequest",
      "params": [
        {
          "name": "flags",
          "type": "#"
    ...
    {
      "id": 574926765,
      "predicate": "communities.peerLinkRequests",
      "params": [
        {
          "name": "flags",
          "type": "#"
    ...
    },
    {
      ...
      "params": [
        ...
        {
          "name": "entities",
          "type": "flags.2?Vector<MessageEntity>"
        },
        {
          "name": "media",
          "type": "flags.3?MessageMedia"
        },
        {
          "name": "reply_markup",
          "type": "flags.4?ReplyMarkup"
        },
        {
          "name": "reply_to",
    ...
    {
      "id": 2373472554,
      "predicate": "communities.participantJoinedChats",
      "params": [
        {
          "name": "creator_chat_ids",
          "type": "Vector<long>"
        },
        {
          "name": "joined_chat_ids",
          "type": "Vector<long>"
        },
        {
          "name": "chats",
    ...
    {
      "id": 1107532175,
      "predicate": "messages.translatedRichMessage",
      "params": [
        {
          "name": "result",
      ...
      "type": "messages.TranslatedRichMessage"
    },
    {
      "id": 1279604680,
      "predicate": "messages.composedRichMessageWithAI",
      "params": [
        {
          "name": "result",
          "type": "RichMessage"
  ...
  "methods": [
    ...
    },
    {
      ...
      "params": [
        ...
        {
          "name": "tone",
          "type": "flags.2?InputAiComposeTone"
        }
      ],
      "type": "messages.ComposedMessageWithAI"
    },
    ...
    },
    {
      ...
      "params": [
        ...
        {
          "name": "text",
          "type": "flags.1?Vector<InputRichMessage>"
        },
        {
          "name": "to_lang",
          "type": "string"
